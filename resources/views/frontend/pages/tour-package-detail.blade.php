...
@section('hero')
<section id="hero" class="d-flex align-items-center" style="background-size: cover; background-image: url('{{ asset('assets/upload/packet/'.$getDetail->thumbnail)}}');">
    <div class="container" data-aos="zoom-out" data-aos-delay="100">
        <h1 class="text-white">{{$getDetail->title}}</h1>
    </div>
</section>
@endsection
@section('content')
<section id="custom-detail">
    <div class="container" data-aos="fade-up">
        <div class="row mt-3">
            <div class="col-md-8">
                <img class="img-fluid" src="{{asset('assets/upload/packet/'.$getDetail->thumbnail)}}" alt="thumbnail">
            </div>
            ...
            <div class="col-md-6 mt-3">
                ...
                <p style="text-align: justify; font-size: 11pt;">{!!$getDetail->summary_and_detination!!}</p>
            </div>
            <div class="col-md-6 mt-3">
                <h3 class="my-3">Syarat dan Ketentuan</h3>
                <p style="text-align: justify; font-size: 11pt;">{!!$getDetail->term_and_condition!!}</p>
            </div>
            <div class="col-md-6 mt-3">
                <h3 class="my-3">Jadwal dan Kegiatan</h3>
                <p style="text-align: justify; font-size: 11pt;">{!!$getDetail->schedule_and_activities!!}</p>
            </div>
            <div class="col-md-6 mt-3">
                <h3 class="my-3">Harga dan Fasilitas</h3>
                <p style="text-align: justify; font-size: 11pt;">{!!$getDetail->price_and_facilities!!}</p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <span>
                    <img class="img-fluid" src="{{asset('assets/upload/packet-gallery/'.$item->image)}}" alt="">
                </span>
            </div>
            @empty
            <div class="col-md-3 col-sm-6 mb-4">
...
<section id="rate" class="contact">
    <div class="container" data-aos="fade-up">
        <form action="{{url('/tour-packages/detail/send/'.$getDetail->slug)}}" method="POST" role="form" class="php-email-form">
            @csrf
