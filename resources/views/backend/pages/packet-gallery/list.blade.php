...
@endsection
@section('onPage')
Master Web > Paket > <span style="color: #4e73df;">List Paket Galeri</span>
@endsection
@section('content')
<div class="row">
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Form Data Galeri Paket</h6>
            </div>
            <form class="card-body" method="POST" enctype="multipart/form-data" action="{{url('/admin/packet/list-gallery-packet/store')}}">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-icon-split mt-2 float-right" type="submit">
                        ...
                        <span class="text">Simpan Paket Galeri</span>
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-flex justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary pt-2">List Data Galeri Paket</h6>
                </div>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered thisDisplay" id="dataTablePacketGallery" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><center><img src="{{asset('assets/upload/packet-gallery/'.$item->image)}}" style="width: 150px;"></center></td>
                                <td class="align-middle">{{$item->caption}}</td>
                                <td class="align-middle"><center>
                                    <form action="{{url('/admin/packet/list-gallery-packet')}}/{{$item->id}}/edit" method="GET" class="d-inline">
                                        <button type="submit" class="btn btn-sm btn-info btn-circle">
                                            <i class="fas fa-pencil-alt"></i>
                                        </button>
                                    </form> |
                                    <form action="{{url('/admin/packet/list-gallery-packet')}}/{{$item->id}}/drop" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
...
<script type="text/javascript">
    $(document).ready( function () {
        $('#dataTablePacketGallery').DataTable();
    });
</script>
@endsection