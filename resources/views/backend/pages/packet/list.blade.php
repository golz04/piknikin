...
<div class="row">
    <div class="col-12">
        <a href="{{url('/admin/packet/list-packet/add')}}">
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">List Data Paket</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered thisDisplay" id="dataTablePacketList" width="100%" cellspacing="0">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><center><img src="{{asset('assets/upload/packet/'.$item->thumbnail)}}" style="width: 150px;"></center></td>
                                <td class="align-middle"><center>
                                    <form action="{{url('/admin/packet/list-packet')}}/{{$item->id}}/edit" method="GET" class="d-inline">
                                        <button type="submit" class="btn btn-sm btn-info btn-circle">
                                            <i class="fas fa-pencil-alt"></i>
                                        </button>
                                    </form> |
                                    <form action="{{url('/admin/packet/list-packet')}}/{{$item->id}}/drop" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
